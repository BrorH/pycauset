...
class TestCoordinates(unittest.TestCase):
    def test_seed_consistency(self):
        ...
        seed = 12345
        n = 50
        c1 = CausalSet(n=n, seed=seed, spacetime=spacetime.MinkowskiDiamond(2))
        c2 = CausalSet(n=n, seed=seed, spacetime=spacetime.MinkowskiDiamond(2))
    ...
    def test_seed_sensitivity(self):
        ...
        n = 50
        c1 = CausalSet(n=n, seed=11111, spacetime=spacetime.MinkowskiDiamond(2))
        c2 = CausalSet(n=n, seed=22222, spacetime=spacetime.MinkowskiDiamond(2))
    ...
    def test_dimension_consistency(self):
        ...
        c2 = CausalSet(n=10, spacetime=spacetime.MinkowskiDiamond(2))
        self.assertEqual(c2.coordinates().shape[1], 2)
        
        c3 = CausalSet(n=10, spacetime=spacetime.MinkowskiDiamond(3))
        self.assertEqual(c3.coordinates().shape[1], 3)
        
        c4 = CausalSet(n=10, spacetime=spacetime.MinkowskiDiamond(4))
    ...
    def test_indices_subset(self):
        ...
        c = CausalSet(n=100, seed=42, spacetime=spacetime.MinkowskiDiamond(3))
