...
from typing import Any, MutableMapping, Optional, Tuple, Union, overload
...
class AntiSymmetricMatrix(SymmetricMatrix):
    def __init__(self, n: int) -> None: ...
...
def symmetric(data: Any, *, rtol: Optional[float] = None, atol: Optional[float] = None) -> Any: ...

def antisymmetric(data: Any, *, rtol: Optional[float] = None, atol: Optional[float] = None) -> Any: ...

def vector(source: Any, dtype: Any = None, *, max_in_ram_bytes: int | None = None, **kwargs: Any) -> VectorBase: ...
