...
def CausalMatrix(source: Any, populate: bool = True, **kwargs: Any) -> TriangularBitMatrix: ...
...
class Matrix(MatrixBase, MatrixMixin):
    def __new__(cls, data_or_n: Union[int, Any], dtype: Any = ..., **kwargs: Any) -> MatrixBase: ...
...
def Vector(size_or_data: Any, dtype: Any = None, **kwargs: Any) -> VectorBase: ...
